    ...
    <div className="w-full">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400">
          아이온2 정보 사이트에 오신 것을 환영합니다
        </p>
      </div>

      {/* 소셜 로그인 아이콘 - 회원가입과 동일한 위치 및 스타일 */}
      ...
      <div className="relative my-6">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-[#4A4E5C]"></div>
        </div>
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-[#282A36] text-gray-400">OR</span>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between text-sm">
          <label className="flex items-center cursor-pointer">
            <input
              ...
              className="w-4 h-4 rounded border-[#4A4E5C] bg-[#363946] text-purple-600 focus:ring-purple-500 focus:ring-offset-0"
              disabled={isLoading}
            />
            <span className="ml-2 text-gray-400">로그인 상태 유지</span>
          </label>
